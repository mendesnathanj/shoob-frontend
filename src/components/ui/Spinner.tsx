...
const colorClasses = {
  ...
  yellow: 'text-gray-300 fill-yellow-500',
};
...
export default function Spinner({ className = '', color = 'blue', size = 'md' }: SpinnerProps) {
  const colorClass = colorClasses[color];
  const sizeClass = sizeClasses[size];

  return (
    <svg role="status" className={`mr-2 ${sizeClass} ${colorClass} animate-spin ${className}`} viewBox="0 0 100 101" xmlns="http://www.w3.org/2000/svg">
